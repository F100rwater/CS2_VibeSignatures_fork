...
def _prepare_llm_decompile_request(
    ...
    return _ida_llm_decompile._prepare_llm_decompile_request(
        func_name,
        llm_decompile_specs_map,
        llm_config,
        platform=platform,
        new_binary_dir=new_binary_dir,
        debug=debug,
        preprocessor_scripts_dir=_get_preprocessor_scripts_dir(),
        normalize_temperature_func=normalize_optional_temperature,
        normalize_effort_func=normalize_optional_effort,
    )
