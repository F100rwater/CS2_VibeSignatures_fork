  ...
  en: {
    translation: {
      ...
      symbols: {
        ...
        vfuncIndex: 'Virtual Function Entry Index', vfuncOffset: 'Virtual Function Table Offset',
  ...
  'zh-CN': {
    translation: {
      ...
      symbols: {
        ...
        vfuncIndex: '虚表内索引', vfuncOffset: '虚表内偏移',
  ...
  'zh-TW': {
    translation: {
      ...
      symbols: {
        ...
        vfuncIndex: '虛擬表內索引', vfuncOffset: '虛擬表內偏移',
